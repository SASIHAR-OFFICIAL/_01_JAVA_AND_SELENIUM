...
public class Google_Search_From_Excelx92 {
	...
	public void SearchGoogle(String searchData) throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement searchBox = driver.findElement(By.xpath("//*[@id=\"s_input\"]"));
		searchBox.sendKeys(searchData);
		//Thread.sleep(3000);
		WebElement Down_Button = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/form/button"));
		Down_Button.click();
