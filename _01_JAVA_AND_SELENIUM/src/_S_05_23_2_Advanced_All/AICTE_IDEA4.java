...
// test
	       ...
	       //====================================================================================================================
			...
			//***************TO SELECT ALUMNI **********
			Thread.sleep(10000);
			WebElement Performance_Point = d.findElement(By.xpath("/html/body/app-root/app-institute/div/mat-drawer-container/mat-drawer/div/app-sidenav/div/div[2]/app-vertical-menu/div[7]/a/span[2]/span"));
			Performance_Point.click();
			WebElement Add_participants = d.findElement(By.xpath("/html/body/app-root/app-institute/div/mat-drawer-container/mat-drawer/div/app-sidenav/div/div[2]/app-vertical-menu/div[7]/div/app-vertical-menu/div[2]/a/span[2]/span"));
	        ...
	        for (int rowNum = 1; rowNum <= 31; rowNum++) {
	            ...
	            Thread.sleep(2000);
	            d.navigate().to("https://idealnet.aicte.gov.in/institute/user-details");
//	            Thread.sleep(15000);
//	            d.navigate().refresh();
	            Thread.sleep(10000);
