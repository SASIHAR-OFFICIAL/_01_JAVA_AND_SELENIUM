...
public class Auto_Complete_07_Sasi_2023 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement Search_Box = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div[2]/div[1]/div/div/div/div/div[1]"));
		...
		for (WebElement List_ot_Elements : Search_Box_Text) {
			...
			if (List_ot_Elements.getText().equals("Red")) {
